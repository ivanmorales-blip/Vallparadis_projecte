                ...
                <tr data-id="{{ $center->id }}" class="hover:bg-orange-50 transition duration-200">
                    ...
                    <td class="px-6 py-4 flex space-x-3">
                        ...
                        <button class="activar-desactivar text-sm transition" title="{{ $center->activo ? 'Desactivar' : 'Activar' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 {{ $center->activo ? 'text-red-400 hover:text-red-500' : 'text-green-400 hover:text-green-500' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="{{ $center->activo ? 'M6 18L18 6M6 6l12 12' : 'M5 13l4 4L19 7' }}"/>
                            </svg>
                        </button>
                    </td>
                </tr> 
