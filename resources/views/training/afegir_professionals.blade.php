...
<div class="min-h-screen bg-gray-50 p-8">
    <div class="max-w-6xl mx-auto bg-white rounded-3xl shadow-xl p-10 border border-gray-200">
        ...
        <h1 class="text-4xl font-extrabold text-orange-500 mb-8 text-center tracking-tight">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div>
                ...
                <ul id="available-professionals"
                    class="bg-gray-100 p-5 rounded-2xl min-h-[350px] space-y-3 shadow-inner overflow-y-auto max-h-[500px] 
                           scrollbar-thin scrollbar-thumb-orange-400 scrollbar-track-gray-200 transition-all"
                    ...
                    @foreach($availableProfessionals as $prof)
                        <li draggable="true" ondragstart="drag(event)"
                            ...
                            class="p-4 bg-white rounded-2xl shadow hover:shadow-2xl transition-all cursor-move 
                                   border border-gray-200 flex justify-between items-center hover:bg-orange-50 
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-700 mb-3 flex justify-between items-center">
                    Professionals assignats
                    <span id="assigned-count" class="bg-orange-100 text-orange-700 px-3 py-1 rounded-full text-sm font-semibold shadow-sm">
        ...
        <div class="mt-10 text-center md:text-right flex flex-col md:flex-row justify-end gap-4">
            <button id="save-btn"
                    class="px-8 py-3 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 
            ...
            <a href="{{ route('trainings.show', $training->id) }}"
               class="px-8 py-3 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-2xl shadow-lg transition transform 
